...
def main():
	...
	questions_lengths_train = questions_lengths_train + questions_lengths_val
	...
	joblib.dump(labelencoder,'../models/labelencoder_trainval.pkl')
	...
	model_file_name = '../models/FULL_lstm_1_num_hidden_units_lstm_' + str(args.num_hidden_units_lstm) + \
